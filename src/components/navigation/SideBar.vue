  ...
  <nav class="h-100 shadow">
    <div class="h-100 d-flex flex-column p-2" style="width: 200px">
      ...
      <ul class="flex-grow-1 nav nav-pills d-flex flex-column">
        <!-- Main links -->
        <li v-for="(route, index) of sideBarRoutes" :key="index" class="d-flex flex-column">
          <div class="d-flex">
            <RouterLink
              :to="route.route"
      ...
      <div class="dropdown">
        <button
          class="btn btn-sm btn-outline-primary w-100 d-flex align-items-center dropdown-toggle"
          id="dropdownUser1"
